...
class Problem
{
	public:
		...
		void recurHillClimb(vector<string>& vs, int l, int start, int end);
	...
	private:	
		...
		const int columnCost(const vector<string>& vs , int i , int j, int col, int start, int end);	// hillClimb helper, gives MC of jth alphabet of ith string with others of column col
